...
class Account extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      cfg: {
        btns: [
          { text: '查看', id: 1, click: this.btt },
          { text: '新增', id: 2, click: this.btt },
          { text: '修改', id: 3, click: this.btt },
          { text: '删除', id: 4, click: this.btt },
          { text: '启停', id: 5, click: this.btt },
          { text: '重置密码', id: 6, click: this.btt },
          { text: '绑定线路', id: 7, click: this.btt },
        ],
        filter: [
          {
            active: '部门名称',
