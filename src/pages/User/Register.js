...
//     const url = '/api/Register/send_sms';

//     post(url,{mobile:mobile,user_type:userType}).then(
//       r=>{
//       },
//       e=>{
//       }
...
//     const { userType } = this.state;
//     form.validateFields(['password', 'confirm', 'mobile', 'captcha'], { force: true }, (err, values) => {
//       if (!err) {
